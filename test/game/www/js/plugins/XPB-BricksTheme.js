/*: 
 * @plugindesc XPStyleBattle for MV Theme - Bricks Theme Ver. 0.1.0
 ...
 * @min -4096
 * @max 4096
 * @desc 名前の X 座標 [Default: 57]
 * 
 * @param (integer)name.y
 * @type number
 * @min -4096
 * @max 4096
 * @desc 名前の Y 座標 [Default: -10]
 * 
 ...
 * @type string
 * @desc 名前の縁取り色 [Default: rgba(0,0,0,0.75)]
 * 
 * @param (integer)name.outlineWidth
 * @type number
 * @min 0
 * @max 64
 * @desc 名前の縁取りの太さ [Default: 3]
 * 
 * @param (integer)name.fontSize
 * @type number
 * @min 4
 * @max 64
 * @desc 名前のフォントサイズ [Default: 15]
 * 
